...
public sealed class RestoreClassroomTypeCommandHandler : IRequestHandler<RestoreClassroomTypeCommand>
{
    ...
    public async Task Handle(RestoreClassroomTypeCommand request, CancellationToken cancellationToken)
    {
