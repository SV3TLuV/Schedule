...
public sealed class RestoreDisciplineCommandHandler : IRequestHandler<RestoreDisciplineCommand>
{
    ...
    public async Task Handle(RestoreDisciplineCommand request, CancellationToken cancellationToken)
    {
